...
apt_install dialog python3 python3-pip python3-venv acl nano apt-transport-https
...
sudo cp -r $HOME/coldforge/{favicon,framework,log,web,.dj.json,LICENSE,manage.py,README.md,requirements.txt} /var/coldforge
cd /var/coldforge
